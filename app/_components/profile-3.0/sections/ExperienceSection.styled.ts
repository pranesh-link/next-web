...
export const TimelineItem = styled.div<{ $visible: boolean; $index?: number }>`
  position: relative;
  margin-bottom: 24px;
...
export const ExperienceCard = styled(DarkCard)`
  margin: 0;
`;
...
export const Responsibilities = styled.div<{ $expanded: boolean }>`
  font-size: 15px;
  line-height: 1.7;
  color: var(--text-dim);
  margin: 0 0 8px 0;
