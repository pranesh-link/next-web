...
const SheetPanel = styled.div<{ $open: boolean }>`
  position: fixed;
  bottom: 0;
  left: 0;
  right: 0;
  ...
  /* Desktop: centered popover instead of bottom sheet */
...
const SheetItem = styled.button<{ $active: boolean; $index: number }>`
  width: 100%;
  display: flex;
  align-items: center;
  gap: 14px;
