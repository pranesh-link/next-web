...
/** Container used in the About section to render the resume download CTA + progress animation. */
export const InterestedInProfile = styled(FlexBox)<{
  $isMobile: boolean;
  $disabled?: boolean;
}>`
...
/** Centered banner showing a file-download status message. */
export const DownloadingFileMessage = styled.div`
  padding: 15px;
  border-radius: 5px;
  background: #f0f0f0;
  margin: 0 auto;
